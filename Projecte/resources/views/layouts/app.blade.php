                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <li class="nav-item my-auto mr-2">
                                    ...
                                    <a class="nav-link" href="{{ route('pujarVideo') }}"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-camera-video-fill" viewBox="0 0 16 16">
